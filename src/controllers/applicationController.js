...
import GetReceivedApplicationsService from "../services/applications/getReceivedApplicationsService.js";
...
class ApplicationController {
  ...
  static getReceived = (req, res, next) => GetReceivedApplicationsService.getReceived(req, res, next);
